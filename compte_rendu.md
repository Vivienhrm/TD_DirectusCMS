...
Le script `requetes_directus.php` exécute les 7 requêtes et affiche les résultats JSON. Ces requêtes peuvent également être testées manuellement dans un navigateur ou un client comme Postman en utilisant l'URL et le jeton d'authentification.
